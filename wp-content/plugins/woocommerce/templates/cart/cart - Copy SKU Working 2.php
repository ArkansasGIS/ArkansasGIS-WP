...
<input type="radio" name="opt_servicemode" value="sync">     Desktop (This may take a while...)<BR>
...
<input name="opt_requesteremail" type="text" value="If selected..." />Email<BR>
