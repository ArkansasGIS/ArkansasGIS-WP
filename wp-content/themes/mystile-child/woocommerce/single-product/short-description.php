	...
	<?php 
	 ...
	 if($pa_attributes['imagery']){
	 	if($product_cat == 'Elevation'){
	 		...
	 		echo '<a href="http://www.geostor.org/S3Browser/Default.aspx?bucketname=geostor-elevation.geostor.org&path='.$product->get_attribute('imagery').'"><img src="'.wp_get_attachment_url(7210).'" height="42" width="42">&nbsp;&nbsp;&nbsp;&nbsp;Click Here Browse The LIDAR Repository</a><br><br>'; 
	 		...
	 		echo '<a href="http://www.geostor.org/S3Browser/Default.aspx?bucketname=geostor-imagery.geostor.org&path='.$product->get_attribute('imagery').'"><img src="'.wp_get_attachment_url(7210).'" height="42" width="42">&nbsp;&nbsp;&nbsp;&nbsp;Click Here Browse the Imagery Repository</a><br><br>'; 
	 	
	 	}
	 }else{
	 	echo '<a href="http://geostor-vectors.geostor.org/'.$product_cat.'/SHP/'.$product->get_sku().'.zip"><img src="'.wp_get_attachment_url(210).'" height="42" width="42">&nbsp;&nbsp;&nbsp;&nbsp;Statewide ZIP file (Shapefile - UTM Zone 15N)</a><br><br>'; 
	 	echo '<a href="http://geostor-vectors.geostor.org/'.$product_cat.'/FGDB/'.$product->get_sku().'.zip"><img src="'.wp_get_attachment_url(210).'" height="42" width="42">&nbsp;&nbsp;&nbsp;&nbsp;Statewide ZIP file (FGDB - UTM Zone 15N)</a><br><br>';
