...
<div itemprop="description">
	<?php 
	 ...
	 if($pa_attributes['imagery']){
	 	...
	 	if($product_cat != 'Maps'){
	 		echo '<a href="http://gis.arkansas.gov/arcgis/rest/services/FEATURESERVICES/'.$product_cat.'/MapServer" class="button product_type_wms" style="width:150px"><span>&nbsp;Web Map Service</span></a>';
			echo '&nbsp;&nbsp;';
			echo '<a href="http://gis.arkansas.gov/arcgis/rest/services/FEATURESERVICES/'.$product_cat.'/FeatureServer" class="button product_type_wms" style="width:150px"><span>&nbsp;Web Feature Service</span></a><br><br>';  
