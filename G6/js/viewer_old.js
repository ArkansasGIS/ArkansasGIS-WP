...
function executeQueryTask(evt) {
	...
	queryTask.execute(query, function(fset) {
		...
		var numFeatures = fset.features.length;
                ...
                var iwtitle_add = "Includes current legislative district information and newly approved districts, to take effect 2013.";
...
function returnRResults(candidates) {
	outAddr = '';
//  	outAddr = '<br />Approximate Address:<br />' + candidates.address["Address"];
	outAddr = '<br />Approximate Address:<br />' + candidates.address["Address"] + '<br />' + candidates.address["City"] + ', AR, ' + candidates.address["ZIP"];
