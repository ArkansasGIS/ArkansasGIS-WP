                    ...
                    if (validate_dl()) {
                        ...
                        switch (selected) {
                            case 0:
                                ...
                                Clipper = "ADMIN.DBO.COUNTIES_AHTD";
                                break;
                            case 1:
                                WhereClause = "where CITY_NAME = |" + $('#city option:selected').text() + "|";
                                Clipper = "ADMIN.DBO.CITY_LIMITS_AHTD";
                                break;
                            case 2:
                                WhereClause = "where HUC_8 = |" + $('#water').val() + "|";
                                Clipper = "WATER.DBO.BASINS_HUC8_NRCS";
                                break;
                            case 3:
