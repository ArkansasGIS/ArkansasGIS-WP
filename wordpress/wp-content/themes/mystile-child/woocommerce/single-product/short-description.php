 ...
 */
 global $product;
		...
		$publisherArray = $atts['Publisher'];
		if($publisherArray && ! is_wp_error($publisherArray)){
			$publisher = $publisherArray['value'];
		}else{
			$publisher = "Not Assigned";
		}
		$pubdateArray = $atts['Pubdate'];
		if($pubdateArray && ! is_wp_error($pubdateArray)){
			$pubdate = $pubdateArray['value'];
		}else{
...
<div itemprop="description">
	<?php 
	 ...
	 echo '<strong>Publication Date: </strong>'.$publisher.'<br><br>'; 
